            ...
            <div className="max-w-xl flex flex-col gap-10">
                    ...
                    <Form className="grid gap-5">
                        ...
                        <ErrorMessage name="password" component="div" className="text-red-500" />
                        {
                            loading ? <LoadingSubmitForm />
                                : <button type="submit" className="justify-self-end bg-indigo-600 text-slate-200 text-2xl font-semibold rounded-md px-6 py-2 hover:bg-indigo-500 transition duration-100">Ingresar</button>
                        }
                    </Form>
                </Formik>
                {hasLoginError && (
                ...
                <div className="flex flex-col">
                    <span className="font-semibold flex flex-wrap justify-center">
                        ...
                        <Link href="/gestionDeContrasena/recuperarContrasena" className="text-teal-300">
