            ...
            <div className="max-w-xl flex flex-col gap-10">
                ...
                >
                    <Form className="grid gap-5">
                        <Field id="email" name="email" placeholder=" Dirección de correo electrónico" className="h-10 pl-4 border-2 border-zinc-200 rounded-lg" />
                        <ErrorMessage name="email" component="div" className="text-red-500" />
                        <Field id="password" name="password" placeholder=" Contraseña" className="h-10 pl-4 border-2 border-zinc-200 rounded-lg" />
